...
class BERTScoreMedicalEvaluator:
    ...
    def evaluate(self, sample_size=500):
        ...
        # 결과 저장
        output_path = "evaluation_results_bertscore.json"
...
def main():
    """메인 실행 함수"""
    print("🚀 BERTScore 의료 모델 평가 시작")
    print("=" * 50)
    
    # 평가자 초기화
    evaluator = BERTScoreMedicalEvaluator()
    
    # 평가 실행
    results = evaluator.evaluate(sample_size=500)
    
    print("\n🎉 BERTScore 의료 모델 평가 완료!")
